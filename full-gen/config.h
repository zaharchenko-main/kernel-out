...
#define CFG_DEMO_MANY_OPTIONS 1
#define USE_DEMO_MANY_OPTIONS(...) __VA_ARGS__
#define CFG_DEMO_NUMBER 1
#define USE_DEMO_NUMBER(...) __VA_ARGS__
#define CFG_DEMO_SCANKEY 1
#define USE_DEMO_SCANKEY(...) __VA_ARGS__
#define CFG_DEMO_UTF8TOWC 1
#define USE_DEMO_UTF8TOWC(...) __VA_ARGS__
#define CFG_HELLO 1
#define USE_HELLO(...) __VA_ARGS__
#define CFG_HOSTID 0
#define USE_HOSTID(...)
#define CFG_LOGPATH 1
#define USE_LOGPATH(...) __VA_ARGS__
