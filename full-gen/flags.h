...
// demo_many_options ZYXWVUTSRQPONMLKJIHGFEDCBAzyxwvutsrqponmlkjihgfedcba ZYXWVUTSRQPONMLKJIHGFEDCBAzyxwvutsrqponmlkjihgfedcba
...
// demo_number D#=3<3M#<0hcdbs D#=3<3M#<0hcdbs
...
// mke2fs <1>2g:Fnqm#N#i#b# <1>2g:Fnqm#N#i#b#
#undef OPTSTR_mke2fs
...
// skeleton (walrus)(blubber):;(also):e@d*c#b:a (walrus)(blubber):;(also):e@d*c#b:a
...
// tcpsvd ^<3c#=30<1C:b#=20<0u:l:hEv ^<3c#=30<1C:b#=20<0u:l:hEv
#undef OPTSTR_tcpsvd
...
// wget <1>1(max-redirect)#<0=20d(debug)O(output-document): <1>1(max-redirect)#<0=20d(debug)O(output-document):
#undef OPTSTR_wget
...
#define FLAG_D (1<<29)
#define FLAG_E (1<<30)
#define FLAG_F (1LL<<31)
#define FLAG_G (1LL<<32)
#define FLAG_H (1LL<<33)
#define FLAG_I (1LL<<34)
#define FLAG_J (1LL<<35)
#define FLAG_K (1LL<<36)
#define FLAG_L (1LL<<37)
#define FLAG_M (1LL<<38)
#define FLAG_N (1LL<<39)
#define FLAG_O (1LL<<40)
#define FLAG_P (1LL<<41)
#define FLAG_Q (1LL<<42)
#define FLAG_R (1LL<<43)
#define FLAG_S (1LL<<44)
#define FLAG_T (1LL<<45)
#define FLAG_U (1LL<<46)
#define FLAG_V (1LL<<47)
#define FLAG_W (1LL<<48)
#define FLAG_X (1LL<<49)
#define FLAG_Y (1LL<<50)
#define FLAG_Z (1LL<<51)
#endif
...
#define FLAG_c (1<<1)
#define FLAG_s (1<<2)
#define FLAG_norc (1<<3)
#define FLAG_noprofile (1<<4)
#define FLAG_noediting (1<<5)
#endif
...
#define FLAG_d (1<<3)
#define FLAG_e (1<<4)
#define FLAG_also (1<<5)
#define FLAG_blubber (1<<6)
#define FLAG_walrus (1<<7)
#endif
