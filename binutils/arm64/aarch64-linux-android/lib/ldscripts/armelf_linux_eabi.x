...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("/home/jeka_zaharchenko/binutils/arm64/aarch64-linux-android/lib"); SEARCH_DIR("/home/jeka_zaharchenko/binutils/arm64/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
